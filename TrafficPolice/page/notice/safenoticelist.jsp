...
<%@ include file="../head/head.jsp"%>
	<div class="main">
		<div class="box">
			<div class="jt_h3 pos">
				<span class="main_left"><img src="page/images/icon04.png" align="absmiddle" />&nbsp;&nbsp;安全提醒</span>
				<span class="gb"><a href="#"><img src="page/images/close.png" width="10" height="10" /></a></span>
			</div>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<div style="border:2px solid #D8DFEA;height:500px">
						  <ul class="fg_list1" id='noticelisthtml'>
						<%--   <li >
						    <a style="cursor:pointer;" onmousemove=this.style.color="blue" onmouseout=this.style.color="#044885" class="limit" limit="25" 
						        title="${noticeTitle} onclick="loadRuleContent('+${id}+')">${noticeTitle}
						  </a>
						  </li> --%>
						  </ul>
							<div class="clear"></div>
...
//分页回调函数
 function pageselectCallback(page_index, jq){
	...
	$.ajax({
		type       :'post',												//可选get
		url        :'getSafeNoticeDatadetailList.action',				//这里是接收数据的PHP程序
