...
<body>
	...
	<div class="pageTitle">${title}</div>
		<div class="pageColumn">
				...
				<form id="searchform" name="searchform" action="<%=basePath%>page/admin/page/unitback_viewUnitList.action">
			...
			<table>
				...
				<td width="1%"></thead>
				<tbody>
				 <s:if test="#request.unitList.size() == 0">
					<tr>
