...
<body>
	<div id="contentWrap">
		...
		<form id="company_search_form" name="company_search_form" action="<%=basePath%>page/admin/page/companyback_viewCompanyList.action">
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td width="10%" style="text-align:right">企业名称:&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td width="90%" style="text-align:left">
					<select name="comid" id="comid">
					<option value="">请选择企业安全组</option>
					<s:iterator value="companyList" >
					<option value="<s:property value="comid"/>"><s:property value="comname"/></option>
					</s:iterator>
					</select>&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="submit" value="查询" />&nbsp;&nbsp;
						<input type="button" value="取消" onClick="company_search_reset();"/>
					</td>
				</tr>
			</table>
		</form>
				...
				<tbody>
					...
					<tr>
						<td class="table-cell" style="text-align:center">
							<input name="id" type="checkbox" class="idcheck" value="<s:property value='comid' />"/>
						</td>
