...
<body>
	<div id="contentWrap">
		...
		<form id="company_search_form" name="company_search_form" action="<%=basePath%>page/admin/page/safegroupback_viewAllSafeGroup.action">
			<table class="main-talbe">
				  <tr>
					  ...
					  <s:iterator value="safeList">
					  <option value=<s:property value="groupid"/> <s:if test="searchname == groupid">selected="selected"</s:if>><s:property value="groupname"/></option>
					  </s:iterator>
					  </select>
				    </td>
		...
		<form id="company_list_form" name="company_list_form" action="${opt.delAllAction}">
			<table>
				...
				<tbody>
					...
					<s:else>
						<s:iterator value="safeGroupCarDriverList" status="safeGroup">
					<tr>
						...
						<td style="text-align:left">&nbsp;&nbsp;<s:property value="zzdriver.name" /></td>
						<td style="text-align:left">&nbsp;&nbsp;<s:property value="car.busLicPlate"/></td>
		...
		<form action="page/admin/page/safegroupcardriverback_addSafeGroupCarDriver.action" id="form2">
