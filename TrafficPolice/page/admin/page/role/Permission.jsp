	...
	<br><br>
			<table bgcolor="white" align="center" width="30%" >
				<tr style="height: 45px">
				    <td style="text-align: center"><h1>角色名称:${dom.rolename}<input type="hidden" name="roleno" value="${dom.roleno }"></h1></td>
				</tr>
				<tr>
					<td>
...
function persission_filter(page,perid) {
	$('#permission_treeboxreagent_tree').html('');
	$('#permission_treeboxreagent_tree').append("<div id=\"image\"><br/><br/><br/><br/><br/><img src=\"/TrafficPolice/page/images/wait.gif\"><br/><br/>正在载入，请稍后...</div>");
	permission_tree = null;
	permission_tree = new dhtmlXTreeObject("permission_treeboxreagent_tree","100%","100%",0);
