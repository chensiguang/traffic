...
<body style="padding-top: 10px">
	<div id="contentWrap" align="center">
		<form name="safenotice_edit_form" id="safenotice_edit_form" action="${action}" method="post">
...
<%--				<tr style="height: 45px">
					<td>添加附件:</td>
					<td>
						<input type="file" id="projectfile" name="projectfile" size="80"/>
						<input type="button" value="上传" onClick="noticeadd_fileupload()"/>
					</td>
				</tr>--%>
...
//提交
$(function(){
	$("#safenotice_edit_form").html5Validate(function(){
		this.submit();
	},{
	});
});
