...
<body>
	...
	<div id="contentWrap">
		...
		<div class="pageColumn">
			<form id="searchform" name="searchform" action="<%=basePath%>page/admin/page/branchback_viewBranchList.action">
			<table class="main-talbe">
                 <!-- <tr class="trstyle" >
					<td style="text-align:left" colspan="6"><b>&nbsp;快速处理点信息查询</b></td>
				  </tr>-->
				
				  <tr>
					  <td width="8%" style="text-align:left">&nbsp;名称：</td>
					  <td width="20%" style="text-align:left">&nbsp;
				          <input type="text" name="searchbranchname" id="searchbranchname" value="<s:property value="searchbranch.branchName"/>"></input>
				    </td>
					  <td width="8%" style="text-align:left">&nbsp;地址：</td>
				      <td width="26%" style="text-align:left">
						 <input type="text" size="35" name="searchbranchaddress" id="searchbranchaddress" value="<s:property value="searchbranch.branchAddress"/>"></input>
				    </td>
				  ...
				  <tr class="trstyle">
					  <td colspan="6" style="text-align:center">
							  ...
							  <input type="reset" value="清 空" onClick="branch_reset()" />  
			...
			<form id="branchform" name="branchform" action="${opt.delAllAction}">
			<table>
				<thead>
				...
				<td width="3%"></thead>
				<tbody>
				  <s:if test="#request.branchList.size() == 0">
					<tr>
						<td colspan="10s" style="text-align:left">【暂无数据】</td>
					</tr>
				  </s:if>
				  <s:else>
					<s:iterator value="branchList" status="branch">
						...
						<td style="text-align:left">&nbsp;&nbsp;<s:property value="#branch.index+1"/></td>
							<td style="text-align:left">&nbsp;&nbsp;<s:property value='branchName' /></td>
							<td style="text-align: left" title="<s:property value="branchAddress"/>">&nbsp;&nbsp;
							   <s:if test="%{branchAddress.length() > 20}">
							 	 <s:property value="branchAddress.substring(0,20)"/>
							   </s:if>
							   <s:else>
							...
							<td style="text-align: left">&nbsp;&nbsp;<s:property value="branchPhone"/></td>
							<!--<td><s:property value="lng"/></td>
							<td><s:property value="lat"/></td>-->
							<td style="text-align: left">&nbsp;&nbsp;<s:property value="admin.loginname" /></td>
							<td style="text-align:left">&nbsp;&nbsp;<s:date name="opertime" format="yyyy-MM-dd" /></td>
...
function branch_reset(){
  $('#searchbranchname').attr('value','');
  $('#searchbranchaddress').attr('value','');
