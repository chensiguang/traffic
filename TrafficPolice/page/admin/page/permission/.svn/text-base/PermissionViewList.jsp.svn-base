...
<body>
	...
	<div id="contentWrap">
		...
		<form id="searchform" name="searchform" action="<%=basePath%>page/admin/page/permission_viewPermissionList.action">
			<table class="main-talbe">
				  <tr>
					  <td width="8%" style="text-align:left">&nbsp;权限名称：</td>
					  <td width="20%" style="text-align:left">&nbsp;
				          <input type="text" name="searchpermissionname" id="searchpermissionname" value='<s:property value="searchpermissionname"/>'/>
				    </td>
				  ...
				  <tr class="trstyle">
					  <td colspan="6" style="text-align:center">
							  ...
							  <input type="reset" value="清 空" onClick="permission_reset()" />  
		...
		<form id="permissionform" name="permissionform" action="${opt.delAllAction}">
			<table>
				<thead>
				...
				<s:if test="#request.permissionList.size() == 0">
					<tr>
						<td colspan="12" style="text-align:left">【暂无数据】</td>
					</tr>
				  </s:if>
				  <s:else>
					<s:iterator value="permissionList" status="permission">
						<tr>
						<td class="table-cell">
						<input name="id" type="checkbox" class="idcheck" value="<s:property value='perno' />"/></td>
                           
						   <td  style="text-align:left">&nbsp;&nbsp;<s:property value="#permission.index + 1" /></td>
							<td  style="text-align:left">&nbsp;&nbsp;<s:date name="regtime" format="yyyy-MM-dd" /></td>
							<td style="text-align: left">&nbsp;&nbsp;
									<s:property value='pername' />
							</td>
							<td  style="text-align:left">&nbsp;&nbsp;<s:property value="functions"/></td>
						    <td  style="text-align:left">&nbsp;&nbsp;<s:date name="opertime" format="yyyy-MM-dd hh:mm:ss" /></td>
							
							<td  style="text-align:left">&nbsp;&nbsp;
							<a href="${opt.showAction}?id=<s:property value='perno' />">【详情】</a>
								<a href="${opt.editAction}?id=<s:property value='perno' />">【修改】</a>
								<a href="javascript:deleteData('<s:property value='perno' />')">【删除】</a>
							</td>
						</tr>
					</s:iterator>
					</s:else>
