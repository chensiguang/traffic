...
<body>
	...
	<div class="nav">
		<ul>
			...
			<li><a href="notice_viewNoticeList_Front.action" class="on">通知公告</a>
			</li>
		...
		<div class="lboxc">
					...
					<div class="listLboxc">
						<ul class="listman">
							<li class="on"><img src="style/llist_ico.png" width="20"
								height="20" /><a href="notice_viewNoticeList_Front.action">通知公告</a>
							</li>
							<li><img src="style/llist_ico.png" width="20"
								height="20" /><a href="publicity_viewPublicityList_Front.action">曝光栏</a>
							</li>
						</ul>
					</div>
			...
			<div class="lright">
		      <div class="box3 listtit">
		        <div class="boxt"><strong>通知公告</strong></div>
		        <div class="boxc">
		          <div class="boxcr">
		            <ul class="list1">
		              <s:iterator  value="noticeList" status="notice">		           
		              <li><a  target="_blank" href="notice_viewNotice_Front.action?id=<s:property value='id' />"><i><s:date name="createtime" format="yyyy-MM-dd" /></i><s:property value='title' /></a></li>
		              </s:iterator>
		            </ul>
