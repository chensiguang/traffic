...
<li><a href="enter_viewList_Front.action">企业信息</a></li>
			...
			<li><a href="download_viewDownList_Front.action" class="on">下载中心</a>
			</li>
		</ul>
	</div>
	<div class="m2">
		...
		<div class="lboxc">
			<div class="lleft">
				<div class="listLbox">
					...
					<div class="listLboxc">
						<ul class="listman">
						<s:iterator  value="downMenuList" status="downMenu">
			              <li id="menuID_<s:property value='id' />"><img src="style/llist_ico.png" width="20" height="20" /><a href="download_viewDownList_Front.action?type=<s:property value='id' />"><s:property value='menutitle' /></a></li>			              
		              </s:iterator>				
						</ul>
					</div>
			...
			<div class="lright">
		      <div class="box3 listtit">
		        <div class="boxt"><strong>下载中心</strong></div>
		        <div class="boxc">
		          <div class="boxcr">
		            <ul class="list1">
		              <s:iterator  value="downFileList" status="downFile">		           
		              <li><a href="<s:property value='filepath' />"><i><s:date name="createtime" format="yyyy-MM-dd" /></i><s:property value='filename' /></a></li>
		              </s:iterator>
		            </ul>
...
var cs = document.getElementById("menuID_${curType}");
if(cs != 'null') {
	cs.setAttribute("class", "on");
}
</script>
</html>
