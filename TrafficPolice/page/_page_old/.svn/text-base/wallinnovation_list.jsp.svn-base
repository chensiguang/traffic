...
<body>
	...
	<div class="nav">
		<ul>
			...
			<li><a href="reform_viewReformList_Front.action" class="on">墙材革新</a>
			</li>
	...
	<div class="m2">
		...
		<div class="lboxc">
			<div class="lleft">
					...
					<div class="listLboxc">
						<ul class="listman">
							<li class="on"><img src="style/llist_ico.png" width="20"
								height="20" /><a href="reform_viewReformList_Front.action">墙材革新</a>
							</li>
						</ul>
					</div>
				...
				<div class="box4">
					<div class="boxt">
						<i><a href="dynamicInfo_viewpiList_Front.action">more</a> </i><strong>行业资讯</strong>
					</div>
					<div class="boxc">
						<div class="boxcr">
							<ul class="list1">
			...
			<div class="lright">
		      <div class="box3 listtit">
		        <div class="boxt"><strong>墙材革新</strong></div>
		        <div class="boxc">
		          <div class="boxcr">
		            <ul class="list1">
		              <s:iterator  value="reformList" status="reform">		           
		              <li><a target="_blank"  href="reform_viewReform_Front.action?id=<s:property value='id' />"><i><s:date name="createtime" format="yyyy-MM-dd" /></i><s:property value='title' /></a></li>
		              </s:iterator>
		            </ul>
