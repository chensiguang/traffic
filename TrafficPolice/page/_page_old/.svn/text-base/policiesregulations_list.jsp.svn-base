...
<body>
	...
	<div class="nav">
		<ul>
			...
			<li><a href="policies_viewprList_Front.action" class="on">政策法规</a>
			</li>
		...
		<div class="lboxc">
					...
					<div class="listLboxc">
						<ul class="listman">
							<li class="on"><img src="style/llist_ico.png" width="20"
								height="20" /><a href="policies_viewprList_Front.action">政策法规</a>
							</li>
						</ul>
					</div>
			...
			<div class="lright">
		      <div class="box3 listtit">
		        <div class="boxt"><strong>政策法规</strong></div>
		        <div class="boxc">
		          <div class="boxcr">
		            <ul class="list1">
		              <s:iterator  value="policiesList" status="policies">		           
		              <li><a  target="_blank" href="policies_viewpr_Front.action?id=<s:property value='id' />"><i><s:date name="createtime" format="yyyy-MM-dd" /></i><s:property value='title' /></a></li>
		              </s:iterator>
		            </ul>
