...
<body>
	...
	<div class="nav">
		<ul>
			...
			<li><a href="wall_viewList_Front.action" class="on">墙材信息</a>	</li>
					...
					<div class="listLboxc">
						<ul class="listman">
							<li class="on">
								...
								<!--<a href="reform_viewReformlist_Front.action">墙材信息</a>-->
								<a href="wall_viewList_Front.action">墙材信息</a>
							</li>
						</ul>
					</div>
			...
			<div class="lright">
				<div class="box3 leirong">
					...
					<div class="boxc">
						...
						-->
						<!-- 新墙材列表 分页 -->
						<div class="boxcr" id="wallinfo_list_page_div"></div>
					</div>
					<div class="boxb">
						<div class="l"></div>
						<div class="r"></div>
