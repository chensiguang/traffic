...
<body>
	...
	<div class="nav">
		<ul>
			...
			<li><a href="dynamicInfo_viewcwList_Front.action" >信息动态</a>
			</li>
...
<li><a href="enter_viewList_Front.action">企业信息</a></li>
			...
			<li><a href="product_viewProductList_Front.action" class="on">产品展示</a>
			</li>
		...
		<div class="lboxc">
			<div class="lleft">
				<div class="listLbox">
					...
					<div class="listLboxc">
						<ul class="listman">
							<li class="on"><img src="style/llist_ico.png" width="20"
								height="20" /><a href="product_viewProductList_Front.action">产品展示</a>
							</li>
						</ul>
					</div>
				...
				<div class="box4">
					<div class="boxt">
						<i><a  target="_blank" href="dynamicInfo_viewcwList_Front.action">more</a> </i><strong>信息动态</strong>
					</div>
					<div class="boxc">
						<div class="boxcr">
							<ul class="list1">
			...
			<div class="lright">
		      <div class="box3 listtit">
		        <div class="boxt"><strong>产品展示</strong></div>
		        <div class="boxc">
		          <div class="boxcr">
		            <div class="rongqi2" >
		              <s:iterator  value="productList" status="product">
		              <dl>
			            <dt><a  target="_blank"  href="product_viewProduct_Front.action?id=<s:property value='id' />"><img src="<s:property value='image' />" alt="<s:property value='pname' />" width="135" height="98"></a></dt>
			            <dd><a  target="_blank"  href="product_viewProduct_Front.action?id=<s:property value='id' />"><s:property value='pname' /></a></dd>
			          </dl>
		              </s:iterator>
		            </div>
