		...
		<div class="lboxc">
			...
			<div class="lright">
		      <div class="box3 listtit">
		        <div class="boxt"><strong>行业资讯</strong></div>
		        <div class="boxc">
		          <div class="boxcr">
		            <ul class="list1">
		              <s:iterator  value="dynamicInfoList" status="dynamicInfo">		           
		              <li><a  target="_blank" href="dynamicInfo_viewpi_Front.action?id=<s:property value='id' />"><i><s:date name="createtime" format="yyyy-MM-dd" /></i><s:property value='title' /></a></li>
		              </s:iterator>
		            </ul>
