...
<body>
	...
	<div class="nav">
		<ul>
			...
			<li><a href="agencyfunc_viewAgencyfunc.action" class="on" >政务公开</a>
			</li>
		...
		<div class="lboxc">
					...
					<div class="listLboxc">
						<ul class="listman">
							<li ><img src="style/llist_ico.png" width="20"
								height="20" /><a href="agencyfunc_viewAgencyfunc.action">机构职能</a>
							</li>
							<li class="on"><img src="style/llist_ico.png" width="20" height="20" /><a
								href="enchiridion_viewList_Front.action">办事指南</a>
							</li>
						</ul>
					</div>
			...
			<div class="lright">
		      <div class="box3 listtit">
		        <div class="boxt"><strong>办事指南</strong></div>
		        <div class="boxc">
		          <div class="boxcr">
		            <ul class="list1">
		              <s:iterator  value="enchiridionList" status="enchiridion">		           
		              <li><a  target="_blank" href="enchiridion_viewEnchiridion_Front.action?id=<s:property value='id' />"><i><s:date name="creattime" format="yyyy-MM-dd" /></i><s:property value='title' /></a></li>
		              </s:iterator>
		            </ul>
