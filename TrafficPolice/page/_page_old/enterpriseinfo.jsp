...
<body>
	...
	<div class="nav">
		<ul>
			...
			<!--
			<li><a href="<%=basePath%>enterpriseinfo_list.jsp" class="on">企业信息</a></li>
			<li><a href="<%=basePath%>wallinfo_list.jsp">墙材信息</a></li>
			-->
			<li><a href="enter_viewList_Front.action" class="on">企业信息</a></li>
			...
			<div class="lleft">
				<div class="listLbox">
					...
					<div class="listLboxc">
						<ul class="listman">
							<li class="on">
								<img src="style/llist_ico.png" width="20" height="20" />
								<!--<a href="<%=basePath%>enterpriseinfo_list.jsp">企业信息</a>-->
								<a href="enter_viewList_Front.action">企业信息</a>
							</li>
						</ul>
					</div>
				...
				<div class="box4">
					<div class="boxt">
						<i><a href="#">&raquo;more</a>
						</i><strong>企业信息</strong>
					</div>
					<div class="boxc">
						<div class="boxcr">
							<!--
							<ul class="list1">
								<li><a href="#"><i>06/05</i>道路科研创新团队</a>
								</li>
								<li><a href="#"><i>06/05</i>道路科研创新团队</a>
								</li>
								<li><a href="#"><i>06/05</i>道路科研创新团队</a>
			...
			<div class="lright">
				<div class="box3 leirong">
					...
					<div class="boxc">
						<div class="boxcr">
							<!--
							<h1>${agencyfunc.title}</h1>
							<h2>来源:${agencyfunc.source} 发布时间:${agencyfunc.showDataTime} 点击数:${agencyfunc.num}
							</h2>
							<div class="ztlr">
								${agencyfunc.content}
							...
							-->
							<!-- 新型墙材企业详情 -->
							<div class="boxcr" id="enterpriseinfo_info_div"></div>
							<input type="hidden" id="enterpriseinfo_comid" name="enterpriseinfo_comid" value="<s:property value='comid' />"/>
						</div>
					</div>
					<div class="boxb">
						<div class="l"></div>
