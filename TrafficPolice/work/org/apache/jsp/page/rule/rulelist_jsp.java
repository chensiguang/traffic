package org.apache.jsp.page.rule;
...
public final class rulelist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/page/rule/../head/head.jsp");
  }
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<script type=\"text/javascript\" src=\"/TrafficPolice/page/css/css.css\"></script>\r\n");
      out.write("</head>\r\n");
      out.write("\r\n");
      out.write("<body>\r\n");
      out.write("\r\n");
 ...
 String id = (String)request.getParameter("id");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${projectpath}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/page/images/icon01.png\" width=\"18\" height=\"20\" align=\"absmiddle\" />&nbsp;&nbsp;交通法规</span><span class=\"gb\"><a href=\"#\"><img src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${projectpath}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      ...
      out.write("\t  <ul class=\"fg_list1\" id='rulelisthtml'>\r\n");
      out.write("        \r\n");
      out.write("      </ul>\r\n");
      out.write("\t\r\n");
      out.write("      <div class=\"clear\"></div>\r\n");
      ...
      out.write("\t</td>\r\n");
      out.write("\t\r\n");
      out.write("\t<td align=\"left\" valign=\"top\" class=\"autowidth\" id=\"contentdetail\">\r\n");
      ...
      out.write("    </div>\r\n");
      out.write("  </div>\t\r\n");
      out.write("<div style=\"color:#fff; text-align:center\">Copyright © 2013  版权所有：浙江网泽科技有限公司  技术支持：浙江网泽科技有限公司</div>\r\n");
      out.write("</div>\r\n");
      out.write("</body>\r\n");
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("var pid=");
      ...
      out.write("\t\turl:'getRuleDateruleList.action',//这里是接收数据的PHP程序\r\n");
      ...
      out.write("\t\t\t{\r\n");
      out.write("\t\t\t\tfor(var i =0 ; i<re.rules.length;i++)\r\n");
      out.write("\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t <!--newcontent +='<li><a onmousemove=this.style.color=\"blue\" onmouseout=this.style.color=\"#044885\" style=\"cursor:pointer;\" href=\"#\" onclick=\"loadRuleContent('+re.rules[i].id+')\">'+re.rules[i].title+'</a></li>';-->\r\n");
      out.write("\t\t\t\t\t  if(pid !=0 && pid == parseInt(re.rules[i].id))\r\n");
      out.write("\t\t\t\t\t  newcontent +='<li><a onmousemove=this.style.color=\"blue\" onmouseout=this.style.color=\"#044885\" style=\"cursor:pointer;color:blue;\" href=\"#\" onclick=\"loadRuleContent('+re.rules[i].id+')\">'+re.rules[i].title+'</a></li>';\r\n");
      out.write("\t\t\t\t\t  else \r\n");
      out.write("\t\t\t\t\t  newcontent +='<li><a onmousemove=this.style.color=\"blue\" onmouseout=this.style.color=\"#044885\" style=\"cursor:pointer;\" href=\"#\" onclick=\"loadRuleContent('+re.rules[i].id+')\">'+re.rules[i].title+'</a></li>';\r\n");
      out.write("\t\t\t\t\t \r\n");
      out.write("\t\t\t\t\t if(i==0 && pid ==0)\r\n");
      out.write("\t\t\t\t\t {\r\n");
      out.write("\t\t\t\t\t \tloadRuleContent(re.rules[i].id);\r\n");
      out.write("\t\t\t\t\t }\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t$('#rulelisthtml').html(newcontent);\r\n");
      out.write("\t\t},\r\n");
      ...
      out.write("\t$.ajax({\r\n");
      out.write("\t\ttype:'post',//可选get\r\n");
      out.write("\t\turl:'getRuleDateinfo.action',//这里是接收数据的PHP程序\r\n");
      out.write("\t\tdata:'ruleid='+id+'&random='+Math.random(),//传给PHP的数据，多个参数用&连接\r\n");
      out.write("\t\tdataType:'Json',//服务器返回的数据类型 可选XML ,Json jsonp script html text等\r\n");
      out.write("\t\tcontentType: \"application/x-www-form-urlencoded; charset=utf-8\", \r\n");
      out.write("\t\tsuccess:function(data){\r\n");
      out.write("\t\t//这里是ajax提交成功后，PHP程序返回的数据处理函数。msg是返回的数据，数据类型在dataType参数里定义！\r\n");
      ...
      out.write("\t\t\t\tnewcontent +='<p style=\"text-align:center;font:14px;\"><strong>'+re.ruleTitle+'</strong></p>';\r\n");
      out.write("\t\t\t\tnewcontent +='<p style=\"text-align:center;\">时间: '+re.ruleInsertTime+'</p>';\r\n");
      out.write("\t\t\t\tnewcontent +='<p>'+re.ruleContent+'</p>';\r\n");
