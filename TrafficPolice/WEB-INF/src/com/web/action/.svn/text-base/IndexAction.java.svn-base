...
public class IndexAction extends BaseAction {
	...
	public String view() {
		...
		setDriverlist(driverService.selectDriverList(0, 6));
		...
		setInterchangelist(interchangeService.selectInterchangeList(0, 20));
		setMicromessagelist(micromessageService.selectMicromessageList(0, 20));
		setCarlist(carService.selectCarList(0, 6));
